...
We use a lightweight Python image and a requirements.txt file that includes the modules that our app requires:
...
To keep things simple, I made a simple HTML page (`frontend/index.html`) where users can chat with the bot:
