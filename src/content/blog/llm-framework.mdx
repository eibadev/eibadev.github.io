...
OpenAI's API platform has its own Playground where you can test function calling, but I wanted a way to be able to test my own local code. I wanted a local chatbot that:
...
This serves the chatbot's front-end.
